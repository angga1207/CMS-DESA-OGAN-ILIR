...
@php
    ...
    $groups = [
        ...
        'Sistem' => [
            ...
            'links' => [
                ...
                ['label' => 'Kritik & Saran', 'href' => route('admin.feedback.index'), 'icon' => 'fa-comments', 'active' => request()->routeIs('admin.feedback.*'), 'feature' => 'feedback'],
    ...
    $titleIcon = match (true) {
        ...
        str_contains($normalizedTitle, 'kritik') || str_contains($normalizedTitle, 'saran') => 'fa-comments',
